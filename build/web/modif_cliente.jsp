<%-- 
    Document   : modif_cliente
    Created on : 28/04/2019, 11:23:22 PM
    Author     : 01
--%>
...
<html>
	...
	<div>
		<form action="" method="get" id="formulario">
			...
			<select>
				<option id="values1C">Cliente 1</option>
				<option id="values2C">Cliente 2</option>
				<option id="values3C">Cliente 3</option>
			</select><br><br>
